...
CREATE TABLE `horarios` (
  ...
  PRIMARY KEY (`Id`),
  KEY `fk_Horarios_Maestro1_idx` (`Maestro_MatriculaMestro`),
  CONSTRAINT `fk_Horarios_Maestro1` FOREIGN KEY (`Maestro_MatriculaMestro`) REFERENCES `maestro` (`MatriculaMestro`)
